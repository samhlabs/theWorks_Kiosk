...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/Git/theWorks_Kiosk/startOMX.sh','/media/Git/theWorks_Kiosk/stopOMX.sh','/media/Git/theWorks_Kiosk/volumeUp.sh','/media/Git/theWorks_Kiosk/volumeDown.sh']
